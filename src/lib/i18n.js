...
const translations = {
    en: {
        ...
        'settings.keyNote': 'Your API key is stored locally and only sent to the currently selected provider or this app server proxy.',
    ...
    zh: {
        ...
        'settings.keyNote': '您的 API 密钥仅存储在本地，只会发送给当前选择的供应商或本应用服务器代理。',
