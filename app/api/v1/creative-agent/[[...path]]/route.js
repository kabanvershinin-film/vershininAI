...
export async function GET(request, { params }) {
    ...
    console.log(`[creative-agent proxy GET] ${targetUrl} | hasApiKey: ${Boolean(apiKey)}`);
...
export async function POST(request, { params }) {
    ...
    const headers = cleanHeaders(request);
    const apiKey = getApiKey(request);
    console.log(`[creative-agent proxy POST] ${targetUrl} | hasApiKey: ${Boolean(apiKey)}`);
...
export async function PATCH(request, { params }) {
    ...
    const headers = cleanHeaders(request);
    const apiKey = getApiKey(request);
    console.log(`[creative-agent proxy PATCH] ${targetUrl} | hasApiKey: ${Boolean(apiKey)}`);
...
export async function DELETE(request, { params }) {
    ...
    const headers = cleanHeaders(request);
    const apiKey = getApiKey(request);
    console.log(`[creative-agent proxy DELETE] ${targetUrl} | hasApiKey: ${Boolean(apiKey)}`);
